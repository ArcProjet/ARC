...
def widthColorAugmentation0(grid):
    res = [[0 for _ in range(len(grid[0]) + 1)] for _ in range(len(grid))]
    for i in range(0, len(grid)):
        for j in range(0, len(grid[i])):
            res[i][j] = grid[i][j]
...
def widthColorAugmentation1(grid):
    res = [[0 for _ in range(len(grid[0]) + 1)] for _ in range(len(grid))]
    for i in range(0, len(grid)):
        for j in range(0, len(grid[i])):
            res[i][j] = grid[i][j]
...
def widthColorAugmentation2(grid):
    res = [[0 for _ in range(len(grid[0]) + 1)] for _ in range(len(grid))]
    for i in range(0, len(grid)):
        for j in range(0, len(grid[i])):
            res[i][j] = grid[i][j]
...
def widthColorAugmentation3(grid):
    res = [[0 for _ in range(len(grid[0]) + 1)] for _ in range(len(grid))]
    for i in range(0, len(grid)):
        for j in range(0, len(grid[i])):
            res[i][j] = grid[i][j]
...
def widthColorAugmentation4(grid):
    res = [[0 for _ in range(len(grid[0]) + 1)] for _ in range(len(grid))]
    for i in range(0, len(grid)):
        for j in range(0, len(grid[i])):
            res[i][j] = grid[i][j]
...
def widthColorAugmentation5(grid):
    res = [[0 for _ in range(len(grid[0]) + 1)] for _ in range(len(grid))]
    for i in range(0, len(grid)):
        for j in range(0, len(grid[i])):
            res[i][j] = grid[i][j]
...
def widthColorAugmentation6(grid):
    res = [[0 for _ in range(len(grid[0]) + 1)] for _ in range(len(grid))]
    for i in range(0, len(grid)):
        for j in range(0, len(grid[i])):
            res[i][j] = grid[i][j]
...
def widthColorAugmentation7(grid):
    res = [[0 for _ in range(len(grid[0]) + 1)] for _ in range(len(grid))]
    for i in range(0, len(grid)):
        for j in range(0, len(grid[i])):
            res[i][j] = grid[i][j]
...
def widthColorAugmentation8(grid):
    res = [[0 for _ in range(len(grid[0]) + 1)] for _ in range(len(grid))]
    for i in range(0, len(grid)):
        for j in range(0, len(grid[i])):
            res[i][j] = grid[i][j]
...
def widthColorAugmentation9(grid):
    res = [[0 for _ in range(len(grid[0]) + 1)] for _ in range(len(grid))]
    for i in range(0, len(grid)):
        for j in range(0, len(grid[i])):
            res[i][j] = grid[i][j]
...
def lengthColorAugmentation0(grid):
    res = [[0 for _ in range(len(grid[0]))] for _ in range(len(grid) + 1)]
    for i in range(0, len(grid)):
        for j in range(0, len(grid[i])):
            res[i][j] = grid[i][j]
...
def lengthColorAugmentation1(grid):
    res = [[0 for _ in range(len(grid[0]))] for _ in range(len(grid) + 1)]
    for i in range(0, len(grid)):
        for j in range(0, len(grid[i])):
            res[i][j] = grid[i][j]
...
def lengthColorAugmentation2(grid):
    res = [[0 for _ in range(len(grid[0]))] for _ in range(len(grid) + 1)]
    for i in range(0, len(grid)):
        for j in range(0, len(grid[i])):
            res[i][j] = grid[i][j]
...
def lengthColorAugmentation3(grid):
    res = [[0 for _ in range(len(grid[0]))] for _ in range(len(grid) + 1)]
    for i in range(0, len(grid)):
        for j in range(0, len(grid[i])):
            res[i][j] = grid[i][j]
...
def lengthColorAugmentation4(grid):
    res = [[0 for _ in range(len(grid[0]))] for _ in range(len(grid) + 1)]
    for i in range(0, len(grid)):
        for j in range(0, len(grid[i])):
            res[i][j] = grid[i][j]
...
def lengthColorAugmentation5(grid):
    res = [[0 for _ in range(len(grid[0]))] for _ in range(len(grid) + 1)]
    for i in range(0, len(grid)):
        for j in range(0, len(grid[i])):
            res[i][j] = grid[i][j]
...
def lengthColorAugmentation6(grid):
    res = [[0 for _ in range(len(grid[0]))] for _ in range(len(grid) + 1)]
    for i in range(0, len(grid)):
        for j in range(0, len(grid[i])):
            res[i][j] = grid[i][j]
...
def lengthColorAugmentation7(grid):
    res = [[0 for _ in range(len(grid[0]))] for _ in range(len(grid) + 1)]
    for i in range(0, len(grid)):
        for j in range(0, len(grid[i])):
            res[i][j] = grid[i][j]
...
def lengthColorAugmentation8(grid):
    res = [[0 for _ in range(len(grid[0]))] for _ in range(len(grid) + 1)]
    for i in range(0, len(grid)):
        for j in range(0, len(grid[i])):
            res[i][j] = grid[i][j]
...
def lengthColorAugmentation9(grid):
    res = [[0 for _ in range(len(grid[0]))] for _ in range(len(grid) + 1)]
    for i in range(0, len(grid)):
        for j in range(0, len(grid[i])):
            res[i][j] = grid[i][j]
