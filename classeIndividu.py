...
class Individu:
    ...
    def __init__(self, numeroConstructeur,pop):
    ...
    def genererGrille(self):
        self.grille = classeGrille.Grille(self.population.imageDepart)
    ...
    def attribuerScore(self):
        ...
        self.score = self.grille.comparer(self.population.imageEsperee) # compare est une méthode de la classe Grid
        
    def croiser2Individus(self, individu2): # on fabrique unn nouvel individu à partir de 2 individus de la génération précédente
        newIndividu = Individu(1,self.population)
